...
$sql = "INSERT INTO game_tbl_comment(parent_comment_id,comment,comment_sender_name,date,title_name) VALUES ('" . $commentId . "','" . $comment . "','" . $commentSenderName . "','" . $date . "','" . $TitleMSG . "')";
